...
*
*	File:	DialogModuleSystemPickup.java
*
******************************************************************/
...
public class DialogModuleSystemPickup extends Dialog {
	
	private CoordinateComboBoxComponent mCoordinateComboBoxComponent = null;
	
	public DialogModuleSystemPickup(Frame parentFrame, Module module) {
		super(parentFrame, "Module System::Pickup");
